...
import { listTestPagination, setLastSearchTest } from '../../actions/writingTest';
...
const mapStateToProps = (state) => {
    return {
        listTest: state.writingTest.listTest,
        ...
        countFetchPage: state.writingTest.countFetchPage,
        countUpdate: state.writingTest.countUpdate,
        lastSearchObj: state.writingTest.lastSearchObj,
    }
}
